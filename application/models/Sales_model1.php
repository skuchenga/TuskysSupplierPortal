...
class Sales_model extends CI_Model{
	...
	public function get_records($from, $to){
		...
		if(isset($from) && isset($to)){
			...
			$sql =  'SELECT [Name],I.[Division Code],I.[Item Category Code],I.[Description] as Description,C.[Description] as Category,sum(T.[Quantity]*-1) as [Quantity],sum(T.[Quantity]*-1*P.[Direct Unit Cost]) as [Price]			
					  ...
					  WHERE I.[Vendor No_]='.$vendor.' AND T.[Date] BETWEEN \''.$from.'\' and \''.$to.'\' GROUP BY [Name],I.[Division Code],I.[Item Category Code],I.[Description],C.[Description] ORDER BY [Name],I.[Division Code],I.[Description],C.[Description]' ;
		}
		else{

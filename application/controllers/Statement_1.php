...
class Statement extends CI_Controller{
	...
	public function index(){
		...
		$data['records'] = $this->Statement_model->get_records($doc);
		$data['header'] = $doc;
		
		$this->load->view('header',$data);
		$this->load->view('navigation',$data);
		$this->load->view('supplier_statement',$data);
	...
	public function get_records(){
		...
		/*$result = $this->Statement_model->get_records();
	...
	function generate_pdf()
	{
		...
		$data = $this->Statement_model->get_records($from,$to);
		...
		$this->cezpdf->ezText('Supplier Statement', 10, array('justification' => 'center'));
		$this->cezpdf->ezSetDy(-10);
	...
	public function generate_excel(){
		...
		$query = $this->Statement_model->get_records_query($from,$to);
        ...
        header('Content-Disposition: attachment;filename="Supplier Statement_'.date('d M y').'.xlsx"');

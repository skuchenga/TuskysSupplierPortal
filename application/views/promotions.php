 ...
 PDF</a>
							...
							<table id="promo_header" class="table">
								...
								?>
										  <tr>
											...
											<td><?php echo ($row['Status'] == 0 ?  "Disabled" :  "Enabled")?></td>
											<td><?php echo $row['Starting Date'];?></td>
											<td><?php echo $row['Ending Date'];?></td>
					...
					<div class="box-body">
					  <table id="example1" class="table table-bordered table-striped">
						...
						?>
									  <tr>
										<td><?php echo $row['Store No_'];?></td>
										<td><?php echo $row['Store'];?></td>
										<td><?php echo $row['ItemCode'];?></td>
										<td><?php echo $row['Description'];?></td>
										<td class="text-right"><?php echo number_format($row['Quantity'],2);?></td>
										<td class="text-right"><?php echo number_format($row['NetAmount'],2);?></td>

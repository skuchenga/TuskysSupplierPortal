			...
			$.ajax({
				...
				success:function(data){
					...
					var areaChartOptions = {
					  ...
					  legendTemplate: "<ul class=\"<%=name.toLowerCase()%>-legend\"><% for (var i=0; i<datasets.length; i++){%><li style=\"background-color:'red'\"><span style=\"background-color:<%=datasets[i].label%>\"></span><%if(datasets[i].label){%><%=datasets[i].label%><%}%></li><%}%></ul>",
